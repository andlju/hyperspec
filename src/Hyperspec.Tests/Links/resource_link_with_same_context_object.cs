...
namespace Hyperspec.Tests.Links
{
    ...
    public class resource_link_with_context_object_and_one_property_not_included : TestBase
    {
        ...
        protected override void Given()
        {
            ...
            Link = new ResourceLink<MyExtendedTestClass>(LinkTemplate, new[] { new ContentContext(testObj, (name, val) => !name.Equals("ExtraString", StringComparison.InvariantCultureIgnoreCase)) });
        }
